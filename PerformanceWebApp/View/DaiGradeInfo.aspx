<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DaiGradeInfo.aspx.cs" Inherits="PerformanceWebApp.View.DaiGradeInfo" %>
        ...
        <div style="margin:10px 10px 5px 100px;font-family:'Microsoft YaHei';">
            <asp:GridView runat="server" ID="GridView1" AllowPaging="True" AutoGenerateColumns="False" BackColor="White" BorderColor="#336666" 
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="FEmCode" HeaderText="编号">
                    <ItemStyle HorizontalAlign="Center" Wrap="False" />
                    </asp:BoundField>
                    <asp:BoundField DataField="FEmName" HeaderText="名称">
                    <ItemStyle HorizontalAlign="Center" Wrap="False" />
                    </asp:BoundField>
                </Columns>
